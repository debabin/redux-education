...
export const GetCharacterNamesDocument = `
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    GetCharacterNames: build.query<GetCharacterNamesQuery, GetCharacterNamesQueryVariables | void>({
      query: (variables) => ({ document: GetCharacterNamesDocument, variables })
    }),
  }),
});

export { injectedRtkApi as api };
export const { useGetCharacterNamesQuery, useLazyGetCharacterNamesQuery } = injectedRtkApi;
